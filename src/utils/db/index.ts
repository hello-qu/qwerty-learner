import type { IArticleRecord, IChapterRecord, IReviewRecord, IRevisionDictRecord, IWordRecord, LetterMistakes } from './record'
import { ArticleRecord, ChapterRecord, ReviewRecord, WordRecord } from './record'
...
class RecordDB extends Dexie {
  ...
  articles!: Table<IArticleRecord, number>
  ...
  constructor() {
    ...
    this.version(4).stores({
      ...
      chapterRecords: '++id,timeStamp,dict,chapter,time,[dict+chapter]',
      reviewRecords: '++id,dict,createTime,isFinished',
      articles: '++id,title,createdAt,updatedAt,currentSentenceIndex',
    })
  }
}
...
db.articles.mapToClass(ArticleRecord)
